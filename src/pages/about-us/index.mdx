...
Block Eden is a San Francisco-based software company that helps web3 developers connect to the Aptos network instantly and securely. We aim to build an all-inclusive platform for web3 developers in the next five years, starting with a genesis product that could immediately serve the Aptos developer community's needs.
...
### Aptos REST and GraphQL API and Node Service

Aptos is building the safest, most-scalable Layer 1 blockchain for Web3 applications.

Our Node Service makes it easy for developers to connect your app to the Aptos blockchain network.

With Aptos REST and GraphQL API and Node Service, you'll be able to quickly develop and deploy new applications that make your customers happy.
